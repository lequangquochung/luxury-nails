  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="absolute right-1 top-1 h-2 w-2 rounded-full bg-red-500 shadow-[0_0_0_3px_rgba(239,68,68,0.18)]" />
        <div className="flex h-[2.125rem] w-[2.125rem] items-center justify-center rounded-full border border-white/20 bg-[linear-gradient(180deg,rgba(255,255,255,0.16),rgba(239,68,68,0.12))] backdrop-blur sm:h-10 sm:w-10">
