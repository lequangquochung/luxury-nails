          ...
          <SlideUp>
            <div className="text-center md:text-left">
              ...
              <p className="mb-6 text-base leading-relaxed text-gold-light sm:text-lg text-left">
                Welcome to SLAYE NAIL BAR, where beauty meets artistry and every
                detail matters. Our journey began with a simple mission: to
                empower confidence and self-expression through exceptional nail
                care in a truly luxurious setting.
              </p>

              <p className="mb-6 text-base leading-relaxed text-gold-light sm:text-lg text-left">
                At SLAYE NAIL BAR, we blend creativity with precision, offering
                a curated experience that goes beyond the ordinary. Our
                passionate team is dedicated to making every visit
                memorable—using only the finest products, the latest techniques,
                and a commitment to uncompromising hygiene. Discover your
                signature style and let your nails make a statement with us.
              </p>
                ...
                <div className="flex items-start justify-center gap-4 text-left transition-all duration-300 hover:translate-x-2 cursor-pointer md:justify-start">
                  ...
                  <div>
                    ...
                    <p className="text-gold-light">
                      Internationally trained professionals with 10+ years
                      experience
                    </p>
                  </div>
                </div>
