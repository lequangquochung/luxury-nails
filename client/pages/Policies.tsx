...
const policyHighlights = [
  {
    ...
    description: "Open communication, clear expectations, and immediate adjustments whenever possible.",
    icon: HandHelping,
  },
  {
    title: "7-day workmanship coverage",
    description: "Qualified lifting, chipping, peeling, and application issues can be reviewed by our team.",
    icon: ShieldCheck,
  },
  {
    title: "Clean and safe service",
    description: "Strict sanitation procedures help protect both clients and technicians at all times.",
    icon: HeartPulse,
  },
];
...
function PolicySection({ title, paragraphs, groups, icon: Icon }: PolicySectionData & { icon: typeof ShieldCheck }) {
  return (
    <motion.article
    ...
    >
      <div className="space-y-5">
        <div className="flex items-center gap-4">
          ...
          <h2 className="min-w-0 text-2xl leading-tight text-foreground sm:text-[1.7rem]">{title}</h2>
        </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-6 text-3xl leading-[0.95] text-foreground sm:text-5xl lg:text-7xl">
                SLAYE Nail Bar policies, written clearly and designed for real expectations.
              </h1>
              <p className="mt-6 max-w-2xl text-base leading-7 text-foreground/72 sm:text-lg">
                This page brings together our service standards, booking expectations, payment terms,
                guarantee details, and in-salon safety rules so every client knows what to expect before
                sitting down.
              </p>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-5 text-3xl leading-tight text-foreground sm:text-4xl">
                By receiving services at SLAYE Nail Bar, you acknowledge and agree to all policies listed above.
              </h2>
              <p className="mt-4 max-w-2xl text-base leading-7 text-foreground/72">
                Policies are in place to protect your experience, support our technicians, and keep the salon calm,
                clean, and consistent for every appointment.
              </p>
            </div>

            <div className="rounded-[1.5rem] border border-border/80 bg-background/70 p-6">
              <div className="text-sm font-semibold uppercase tracking-[0.22em] text-primary/80">Need help before booking?</div>
              <div className="mt-4 space-y-4 text-sm leading-7 text-foreground/74">
                <p>Call, email, or ask our front desk team if you want clarification on timing, eligibility for fixes, or service suitability before your visit.</p>
                <p>We would rather align expectations early than rush decisions at check-in.</p>
              </div>
